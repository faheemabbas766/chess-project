import 'package:fimi_tiger/logic/move_calculation/move_classes/direction.dart';
import 'package:fimi_tiger/logic/move_calculation/move_classes/move_and_value.dart';
import 'package:fimi_tiger/logic/shared_functions.dart';
import 'package:fimi_tiger/views/components/chess_view/promotion_dialog.dart';
  ...
  for (var diagonal in diagonals) {
    ...
    if (_inBounds(row, col)) {
      ...
      if ((takenPiece != null &&
          ...
          _canTakeFiMiTiger(pawn.player, _rowColToTile(row, col), board)) {
...
bool _canTakeFiMiTiger(Player pawnPlayer, int diagonal, ChessBoard board) {
  ...
  return takenPiece != null &&
      ...
      takenPiece == board.FiMiTigerPiece;
}
